...
import { Castle, Ship, X, ChevronLeft, ChevronRight } from 'lucide-react';
import { useScrollAnimation } from '../hooks/useScrollAnimation';
import { getDestinationImage } from '../constants/assets';
...
const PromotionModal = ({
  ...
  return (
    ...
    >
      ...
      >
        {/* Header */}
        <div className={`bg-gradient-to-r ${promotion.bgGradient} p-6 text-white`}>
          <div className="flex items-start justify-between gap-4">
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-yellow text-sm mt-2">Valid: {promotion.validDates}</p>
              </div>
            </div>
            <button
              onClick={onClose}
