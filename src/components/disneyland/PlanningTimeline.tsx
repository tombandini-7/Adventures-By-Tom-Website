...
import { timelineSteps } from '../../data/disneyland';
      ...
      <div className="container mx-auto px-4 lg:px-8">
        ...
        >
          ...
          <p className="text-gray-600 text-lg leading-relaxed">
            Mark these important dates on your calendar to ensure you don&apos;t miss any booking windows for your Disneyland vacation.
          </p>
        </div>
