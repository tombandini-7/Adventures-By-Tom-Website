...
import { firstTimeGuideItems } from '../../data/disneyland';

const iconMap: Record<string, React.ReactNode> = {
  'Why Use a Travel Agent?': <Heart className="w-6 h-6" />,
  'Disneyland App': <Smartphone className="w-6 h-6" />,
      ...
      <div className="container mx-auto px-4 lg:px-8">
        ...
        >
          ...
          <p className="text-gray-600 text-lg leading-relaxed">
            Planning your first Disneyland vacation? Here&apos;s everything you need to know to make the most of your magical adventure.
          </p>
        </div>
