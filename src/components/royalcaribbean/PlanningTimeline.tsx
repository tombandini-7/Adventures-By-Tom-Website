...
import { timelineSteps } from '../../data/royalcaribbean';
...
const PlanningTimeline = () => {
  ...
  return (
    <section id="planning-timeline" className="py-24 bg-white overflow-hidden">
      <div className="container mx-auto px-4 lg:px-8">
        ...
        >
          ...
          <h2 className="font-serif text-3xl md:text-4xl lg:text-5xl text-ocean mb-6">
            Your Royal Caribbean Journey
          </h2>
          <p className="text-gray-600 text-lg leading-relaxed">
            From booking to boarding, I'll guide you through every milestone to ensure a smooth
            sailing experience. Here's what to expect as your cruise approaches.
          </p>
        </div>
        ...
        <div ref={timelineRef} className="hidden lg:block relative pt-52 pb-52">
          {/* Connecting Line */}
          <div className="absolute top-1/2 left-8 right-8 h-1 bg-gradient-to-r from-aqua via-ocean to-magenta transform -translate-y-1/2 rounded-full" />
        ...
        <div className="lg:hidden">
          <div className="relative pl-8 border-l-4 border-gradient-to-b from-aqua to-ocean ml-4">
            {timelineSteps.map((step, index) => (
              <MobileTimelineNode key={step.title} step={step} index={index} />
            ))}
          </div>
        </div>
      </div>
    ...
    >
      ...
      >
        <div className="bg-white rounded-xl shadow-lg p-5 border border-gray-100 card-hover">
          <p className="text-aqua font-bold text-lg mb-1">{step.days}</p>
    ...
    >
      ...
      <div className="bg-white rounded-xl shadow-md p-5 border border-gray-100 ml-4">
        <div className="flex items-start gap-4">
          ...
          <div>
            <p className="text-aqua font-bold text-sm mb-1">{step.days}</p>
